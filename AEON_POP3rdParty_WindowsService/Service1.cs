                                        ...
                                        while (!sr.EndOfStream)
                                        {
                                            ...
                                            if (CREATE_BY != "SYS")
                                            {
                                                ...
                                                if (line >= 100)
                                                {
                                                    ...
                                                    sql_insert_data_ItemPriceChange = String.Format(
                                                        @"INSERT INTO `aeon_pop`.`pricechange_temp`(`PRICE_CHANGE_NO`,`DEPARTMENT`,`TRANS_TYPE`,`REASON`,`EVENT_ID`
                                                                                            ,`PRICE_CHANGE_TYPE`,`PRICE_CHANGE_TYPE_VALUE`,`PROMOTION_TYPE`,`START_DATE`,`DAILY_START_TIME`,`END_DATE`
                                                                                            ,`DAILY_END_TIME`,`STATUS`,`STORE`,`SKU`,`LAST_SELL_PRICE`,`LAST_SELL_UNIT`,`NEW_SELL_PRICE`,`CREATED_DATE`
                                                                                            ,`MODIFIED_DATE`,`FILE_ID`)VALUES");
                                                    line = 0;
                                        ...
                                        while (!sr.EndOfStream)
                                        {
                                            ...
                                            if (CREATE_BY != "SYS")
                                            {
                                                ...
                                                if (line >= 100)
                                                {
                                                    ...
                                                    sql_insert_data_GroupPriceChange = String.Format(
                                                        @"INSERT INTO `aeon_pop`.`group_pricechange_temp`(`PRICE_CHANGE_NO`,`TRANS_TYPE`,`START_DATE`,`START_TIME`
                                                                                            ,`END_DATE`,`END_TIME`,`CATEGORY`,`STORE`,`EVENT_ID`,`EXCLUDE_SEASON_ID`,`PRICE_CHANGE_TYPE`
                                                                                            ,`PRICE_CHANGE_TYPE_VALUE`,`REASON`,`PROMOTION_TYPE`,`STATUS`,`CREATED_DATE`,`MODIFIED_DATE`,`FILE_ID`)VALUES");
                                                    line = 0;
                                                }
                            ...
                            if (filename.Length >= 9)
                            {
                                if (filename.Substring(0, 9) == "SUPPLIER_")
                                {
                                    ...
                                    var sql_insert_profit_file = String.Format(
                                        "INSERT INTO `aeon_pop`.`profit_files_log` (`FILE_DATE`,`FILE_NAME`,`SYS_DATE`,`SYS_TIME`,`MESSAGE`) VALUES('{0}','{1}','{2}','{3}','{4}'); "
                                    ...
                                    using (StreamReader sr = new StreamReader(pathtg))
                                    {
                                        ...
                                        var sql_insert_data_supplier = String.Format(
                                            @"INSERT INTO `aeon_pop`.`supplier_temp`(`SUPPLIER_CODE`,`SUPPLIER_NAME_END`,`SUPPLIER_NAME_VNM`,`SUPPLIER_SHORTNAME_END`,`SUPPLIER_SHORTNAME_VNM`,`SUPPLIER_TYPE`,`DELETE_FLAG`,`PHONE_NUMBER`,`EMAIL_ADDRESS`,`FILE_ID`)VALUES");
                                    ...
                                    var sql_update_profit_file = String.Format(
                                        "UPDATE `aeon_pop`.`profit_files_log` SET `MESSAGE` = \"Successfully\" WHERE `FILE_ID` = '{0}';"
                                        , log_fileid);
                                    connection.Open();
                            ...
                            if (filename.Length >= 14)
                            {
                                if (filename.Substring(0, 14) == "SUPPLCONTRACT_")
                                {
                                    ...
                                    using (StreamReader sr = new StreamReader(pathtg))
                                    {
                                        int line = 0;
                                        //insert data to table
                                        var sql_insert_data = String.Format(@"INSERT INTO `aeon_pop`.`supplier_contract_temp`
                                        ...
                                        while (!sr.EndOfStream)
                                        {
                                            ...
                                            if (line == 100)
                                            {
                                                ...
                                                sql_insert_data = String.Format(@"INSERT INTO `aeon_pop`.`supplier_contract_temp`
                                                                                    (`VN_CODE`,`VN_CONTRACT`,`BRANCH_CODE`,`COMPANY_TAX_REGISTRATION_NO`,`FILE_ID`)VALUES");
                                                line = 0;
                                            }
                                        }
