    ...
    public partial class Service1 : ServiceBase
    {
        ...
        private void myWorker_ItemSellPrice_DoWork(object sender, DoWorkEventArgs e)
        {
                        ...
                        if (fileExt.CompareTo(".csv") == 0)
                        {
                            ...
                            if (filename.Length >= 5)
                            {
                                if (filename.Substring(0, 5) == "ITEM_")
                                {
                                    ...
                                    {
                                        log.Info(string.Format("SKU: Move file to backup successfully! {0}", dirPathBackup));
                                    }
                            ...
                            if (filename.Length >= 10)
                            {
                                if (filename.Substring(0, 10) == "HAMPERMST_")
                                {
                                    ...
                                    //insert data to table HAMPERMST_
                                    ...
                                    if (File.Exists(dirPathBackup))
                                    {
                                        log.Info(string.Format("HAMPERMST: Move file to backup successfully! {0}", dirPathBackup));
                                    }
                            ...
                            if (filename.Length >= 13)
                            {
                                if (filename.Substring(0, 13) == "ITEMPRICECHG_")
                                {
                                    ...
                                    if (File.Exists(dirPathBackup))
                                    {
                                        log.Info(string.Format("ITEMPRICECHG: Move file to backup successfully! {0}", dirPathBackup));
                                    }
                            ...
                            if (filename.Length >= 9)
                            {
                                if (filename.Substring(0, 9) == "MIXMATCH_")
                                {
                                    ...
                                    if (File.Exists(dirPathBackup))
                                    {
                                        log.Info(string.Format("MIXMATCH: Move file to backup successfully! {0}", dirPathBackup));
                                    }
                            ...
                            if (filename.Length >= 12)
                            {
                                if (filename.Substring(0, 12) == "GRPPRICECHG_")
                                {
                                    ...
                                    if (File.Exists(dirPathBackup))
                                    {
                                        log.Info(string.Format("GRPPRICECHG: Move file to backup successfully! {0}", dirPathBackup));
                                    }
                            ...
                            if (filename.Length >= 14)
                            {
                                if (filename.Substring(0, 14) == "ITEMSELLPRICE_")
                                {
                                    ...
                                    if (File.Exists(dirPathBackup))
                                    {
                                        log.Info(string.Format("ITEMSELLPRICE: Move file to backup successfully! {0}", dirPathBackup));
                                    }
                            ...
                            if (filename.Length >= 12)
                            {
                                if (filename.Substring(0, 12) == "ITEMBARCODE_")
                                {
                                    ...
                                    if (File.Exists(dirPathBackup))
                                    {
                                        log.Info(string.Format("ITEMBARCODE: Move file to backup successfully! {0}", dirPathBackup));
                                    }
            ...
            catch (Exception ex)
            {
                ...
                log.Error(string.Format("myWorker_RunWorker Exception: {0}", ex.Message));
            }
        }
